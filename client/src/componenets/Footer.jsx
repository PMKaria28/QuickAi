    ...
    <footer className="mt-20 px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
        <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
            <div className="md:max-w-96">
                {/* <svg strokeWidth="157" height="40" viewBox="0 0 157 40" fill="none" xmlns="http://www.w3.org/2000/svg"> */}
                {/* <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-8">     
                ...
                <p className="mt-6 text-sm">
                    Experience the Power of AI with Quixk Ai.<br/>
        ...
        <p className="pt-4 text-center text-xs md:text-sm pb-5">
            Copyright 2025 © <a href="https://prebuiltui.com">Parva Karia</a>. All Right Reserved.
        </p>
    </footer>
  )
}
